...
<script>
	function validateform() {
		...
		if (feesAmount.value.length <= 0 || isNaN(feesAmount.value)
				|| feesAmount.value.length > 10) {
...
<body>
	...
	<center>
		...
		<form action="addClasses" method="get" modelAttribute="classes"
			onsubmit="return validateform()">

			<label>Class : </label> <input type="text" name="className"
				id="className" placeholder="Enter Class in Roman Number" /> <Br>
			<label>Fees : </label> <input type="text" name="feesAmount"
				id="feesAmount" placeholder="Enter Fees Amount For Class" /> <Br>
