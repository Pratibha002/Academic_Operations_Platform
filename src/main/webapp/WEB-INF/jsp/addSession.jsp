...
<body>
	...
	<center>
		...
		<form action="addsession" method="get" modelAttribute="session"
			onsubmit="return validateform()">

			<label>Session Start : </label> <input type="date"
				name="sessionStart" id="sessionStart" placeholder="dd/mm/yyyy " />
			<Br> <label>Session End : </label> <input type="date"
				name="sessionEnd" id="sessionEnd" placeholder="dd/mm/yyyy" /> <Br>
